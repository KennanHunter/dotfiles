...
plugins=(git docker rust npm python ripgrep)
...
alias ncm="ncmpcpp"
alias musicdl="youtube-dl -xi --add-metadata"
alias du="dust"
alias rls="echo \"You probably didn't mean to do that, if so use (backslash)rls\" "
alias sl="sl | lolcat"
alias weebfetch="neofetch --kitty --source ~/Pictures/lambda-wallpapers/neofetch/dimmed"
